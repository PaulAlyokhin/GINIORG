    ...
    <div id="carouselExampleIndicators" class="carousel slide">
        <div class="carousel-inner">
            ...
            <div class="carousel-item img">
                <img class="d-block w-100" src="assets/img/home-banner.jpg" alt="Second slide">
...
<section class="about-us-section">
    <div class="container">
        <div class="row">
            <div class="col-sm flex-grow-initial"> <img src="assets/img/women.jpg" alt=""> </div>
            <div class="col-sm">
...
<div class="about-certi-wrapper">
    ...
    <section class="certified-section">
        <div class="container">
            <div class="owl-carousel owl-theme" id="carousel-certified">
                <div> <img src="assets/img/CInOrg.png" alt="" class="img-certificate"> </div>
                <div> <img src="assets/img/CDTP.png" alt="" class="img-certificate"> </div>
                <div> <img src="assets/img/CCInO.png" alt="" class="img-certificate"> </div>
                <div> <img src="assets/img/CInOrg.png" alt="" class="img-certificate"> </div>
                <div> <img src="assets/img/CDTP.png" alt="" class="img-certificate"> </div>
                <div> <img src="assets/img/CCInO.png" alt="" class="img-certificate"> </div>
            </div>
    ...
    <section class="membership-section">
        <div class="container">
            <div class="row">
                <div class="col-sm flex-grow-initial"> <img src="assets/img/member-img.jpg" alt=""> </div>
                <div class="col-sm">
        ...
        <div class="owl-carousel owl-theme" id="carousel-accreditation">
            <div>
                <div class="row">
                    ...
                    <div class="col-sm"> <img src="assets/img/Business-Incubator.png" alt="" class="img-certificate"> </div>
                </div>
            </div>
            <div>
                <div class="row">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="row post-row">
                    <div class="col-3 col-featured"><img src="assets/img/index-page-img-3.jpg" alt="" class="featured-image"></div>
                    <div class="col-9">
                        <p class="post-date"><a href="#">15 NOV 2018</a></p>
                        <h2 class="post-title"><a href="#">Maecenas fringilla placerat sapien</a></h2>
                        <p class="post-excerpt">Quisque maximus ac neque quis efficitur. Nunc tempus mauris at tortor facilisis, sit amet posuere ante feugiat. In pharetra velit et turpis commodo...</p>
                            <div class="post-meta"><span class="post-author mr-3"><a href="#">Admin</a></span><span class="post-comments mr-3"><a href="#"><i class="fa fa-comment"></i> 19</a></span> <span class="post-time"><a href="#"> 12 hours ago</a></span></div>
                    </div>
                </div>
                <div class="row post-row">
                    <div class="col-3 col-featured"><img src="assets/img/index-page-img-4.jpg" alt="" class="featured-image"></div>
                    <div class="col-9">
                        <p class="post-date"><a href="#">15 NOV 2018</a></p>
                        <h2 class="post-title"><a href="#">Maecenas fringilla placerat sapien</a></h2>
                        <p class="post-excerpt">Quisque maximus ac neque quis efficitur. Nunc tempus mauris at tortor facilisis, sit amet posuere ante feugiat. In pharetra velit et turpis commodo...</p>
                ...
                <div class="row post-row">
                    <div class="col-3 col-featured"><img src="assets/img/index-page-img-5.jpg" alt="" class="featured-image"></div>
                    <div class="col-9">
                        <p class="post-date"><a href="#">15 NOV 2018</a></p>
            ...
            <div class="col-md-4">
                <div class="book-container">
                    ...
                    <div class="book-wrapper text-center"> <img src="assets/img/gini-master-book.png" alt="" class="gini-master-book"> </div>
