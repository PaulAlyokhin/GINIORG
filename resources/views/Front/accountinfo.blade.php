        ...
        <div class="row align-items-start">
            <div class="col-3 bg-white px-0 account-menu">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link active" id="v-pills-billing-tab" data-toggle="pill" href="#v-pills-billing" role="tab" aria-controls="v-pills-billing" aria-selected="false"><i class="icofont-credit-card"></i> Billing</a>
                    ...
                    <a class="nav-link" id="v-pills-download-tab" data-toggle="pill" href="#v-pills-download" role="tab" aria-controls="v-pills-download" aria-selected="false"><i class="icofont-download"></i> Download Center</a>
            ...
            <div class="col-9 py-3 bg-white account-form">
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade show active billing p-lg-4" id="v-pills-billing" role="tabpanel" aria-labelledby="v-pills-billing-tab">
                        <div class="row">
                    ...
                    <div class="tab-pane fade" id="v-pills-download" role="tabpanel" aria-labelledby="v-pills-download-tab">Download</div>
