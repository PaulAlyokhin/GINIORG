...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ url('assets/css/style.cs') }}s">
   ...
   <div class="pdf-wrapper">
       <div class="container">
           ...
           <div class="pdf-main-heading">
               <h2 class="certerd-heading-block">Certified Design Thinking Professional(CDTP)</h2>
           </div>
               ...
               <div class="row">
                   ...
                   <div class="col-md-3">
                       <div class="logo-mid-left-block">
                           <img src="{{ url('assets/img/CDTP.png') }}" alt="">
                       </div>
                   </div> 
                   <div class="col-md-3">
